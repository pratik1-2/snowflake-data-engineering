-- Chapter 04 Part 3: Logging, event tables, and summary procedures
...
$$
begin
  SYSTEM$LOG_DEBUG('LOAD_CUSTOMER_ORDERS begins');
...
select * from BAKERY_DB.TRANSFORM.BAKERY_EVENTS;
...
$$
begin
  SYSTEM$LOG_DEBUG('LOAD_CUSTOMER_SUMMARY_ORDERS begins');
  truncate table SUMMARY_ORDERS;
  insert into SUMMARY_ORDERS (delivery_date, baked_good_type, total_quantity)
  select  
      delivery_date,
